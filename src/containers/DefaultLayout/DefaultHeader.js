...
import logo from '../../assets/img/brand/logolg.png'
import sygnet from '../../assets/img/brand/logo64.png'
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <AppNavbarBrand
          full={{ src: logo, width: 89, height: 25, alt: 'One Identity' }}
          minimized={{ src: sygnet, width: 30, height: 30, alt: 'One Identity' }}
        />
